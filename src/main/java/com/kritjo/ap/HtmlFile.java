...
public class HtmlFile extends ProvisionFile{
    ...
    public HtmlFile(File file, String name) {
        super(file, name);
    }
    ...
    public void saveProfile(String name) throws IOException {
        ...
        if (profile.createNewFile()) {
            ...
            fileWriter.write("html"+PROFILE_DELIM+tableID+PROFILE_DELIM+gsmNrCol+PROFILE_DELIM+productCol+PROFILE_DELIM+refCol+PROFILE_DELIM+provisionCol);
            fileWriter.close();
        } else {
